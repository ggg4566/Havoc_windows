...
void HavocNamespace::UserInterface::Dialogs::Connect::setupUi( QDialog* Form )
{
    ...
    //Form->setMinimumSize( QSize( 1000, 520 ) );
    Form->setMaximumSize( QSize( 1000, 520 ) );
    ...
    plainTextEdit->setPlainText( " Connect to a havoc teamserver." );
    ...
    //ButtonNewProfile->setMaximumSize( QSize( 250, 50 ) );
    ButtonNewProfile->setStyleSheet("font-size: 20px;");
    ...
    ButtonConnect->setStyleSheet("font-size: 20px;");
